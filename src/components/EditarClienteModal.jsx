...
function EditarClienteModal({ open, onClose, cliente }) {
  ...
  // Cuando el cliente cambie, actualiza el formulario
  useEffect(() => {
    if (cliente) {
      setDatosCliente({
        ...
        detalles: cliente.detallesExtra,
      });
    }
  }, [cliente]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-lg p-6 relative">
        ...
        <h2 className="text-2xl font-bold mb-6 text-neutral-900">Editar cliente</h2>
        ...
        <div className="flex justify-end gap-4 mt-6">
          ...
          <button
            ...
            onClick={() => {
              alert(`Cliente "${datosCliente.nombre}" actualizado.`);
              onClose();
            }}
          >
            Guardar cambios
