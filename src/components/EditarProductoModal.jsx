...
import cementoImg from "../assets/cemento.jpg"; // Usa tu imagen local de cemento


function EditarProductoModal({ open, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-2xl p-6 relative">
        ...
        <h2 className="text-2xl font-bold mb-6 text-neutral-900">Editar producto</h2>
        ...
        <form className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-neutral-700 mb-1">Stock actual</label>
                <input
                  type="number"
                  name="stock"
                  className="w-full border rounded p-2"
